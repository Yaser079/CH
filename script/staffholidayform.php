...
<div class="row">
    <div class="col-md-12">
        ...
        <label for="exampleInputEmail1" class="d-none">Holiday Description</label>
            <input type="text" class="form-control d-none" id="des" placeholder="Enter Description" value="<?= $desc;?>" >
